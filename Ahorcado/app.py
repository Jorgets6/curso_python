...
def main(archivo_texto:str, nombre_plantilla='plantilla'):
    ...
    while o>0:
        fn.despliega_plantilla(plantillas, o) # desplegamos la plantilla
        o = fn.adivina_letra(abcdario, p, adivinadas, o) # adivinamos una letra
        if p == ''.join([letra if letra in adivinadas else '_' for letra in p]): # si se adivina la palabra
