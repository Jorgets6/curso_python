''' Demasiado super me siento como Vegueta '''
...
class SistemaCine:
    ...
    def obtener_actores_por_peliculas(self, id_pelicula):
        ''' Método para obtener los actores de una pelicula '''
...
if __name__ == '__main__':
    ...
    print("----------------------")
    lista_actores = sistema.obtener_actores_por_peliculas(1)
    for actor in lista_actores:
        print(f"{actor.id_estrella}:{actor.nombre}({actor.fecha_nacimiento.year})")
    print("----------------------")
    u = sistema.usuarios['Jorge']
    print(u.username)
